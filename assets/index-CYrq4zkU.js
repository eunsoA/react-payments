...
var CardType = /* @__PURE__ */ ((CardType2) => {
  CardType2["VISA"] = "VISA";
  CardType2["MASTERCARD"] = "MASTERCARD";
  CardType2["UNKNOWN"] = "UNKNOWN";
  return CardType2;
})(CardType || {});
const CARD_TYPE_RULE = Object.freeze({
  [
    "VISA"
    /* VISA */
  ]: {
...
const getCardType = (cardNumber) => {
  ...
  if (first === CARD_TYPE_RULE.MASTERCARD.FIRST_DIGIT && isInRange(
    second,
...
var CardInfoType = /* @__PURE__ */ ((CardInfoType2) => {
  CardInfoType2["NUMBER"] = "cardNumber";
  CardInfoType2["COMPANY"] = "cardCompany";
  CardInfoType2["EXPDATE"] = "cardExpirationDate";
  CardInfoType2["CVC"] = "cardCVC";
  CardInfoType2["PASSWORD"] = "cardPassword";
  return CardInfoType2;
})(CardInfoType || {});
const CARD_INFO_VALID_RULE = Object.freeze({
  [
    "cardNumber"
    /* NUMBER */
  ]: {
...
const NO_ERROR = [-1, ""];
var ErrorKey = /* @__PURE__ */ ((ErrorKey2) => {
  ErrorKey2["CARD_NUMBER"] = "cardNumberError";
  ErrorKey2["CARD_COMPANY"] = "cardCompanyError";
  ErrorKey2["CARD_EXPIRATION_DATE"] = "cardExpirationDateError";
  ErrorKey2["CARD_CVC"] = "cardCVCError";
  ErrorKey2["CARD_PASSWORD"] = "cardPasswordError";
  return ErrorKey2;
})(ErrorKey || {});
const ERROR_MESSAGES = Object.freeze({
  ...
  CARD_PASSWORD: {
    NOT_NUMERIC: "비밀번호는 숫자만 입력 가능합니다.",
    NOT_TWO_DIGIT: "비밀번호는 2자리어야 합니다."
  }
});
const cardNumberValidator = (inputs) => {
  const validations = [
    {
      check: (input) => !isNumeric(input),
      message: ERROR_MESSAGES.CARD_NUMBER.NOT_NUMERIC
    },
    {
      check: (input) => !isExactDigitLength(input, CARD_INFO_VALID_RULE[CardInfoType.NUMBER].MAX_LENGTH),
      message: ERROR_MESSAGES.CARD_NUMBER.NOT_FOUR_DIGIT
    },
    {
      check: (input, index) => index === 0 && !isValidCardType(input),
      message: ERROR_MESSAGES.CARD_NUMBER.INVALID_TYPE
    }
  ];
  const errorIndex = inputs.findIndex(
    (input, index) => validations.some((validation) => validation.check(input, index))
  );
  if (errorIndex !== -1) {
    const input = inputs[errorIndex];
    const error = validations.find((validation) => validation.check(input, errorIndex));
    return [errorIndex, (error == null ? void 0 : error.message) || ""];
  }
  return NO_ERROR;
};
const cardExpirationDateValidator = (date) => {
  const validations = [
    {
    ...
    {
      check: () => !isExactDigitLength(date.month, CARD_INFO_VALID_RULE[CardInfoType.EXPDATE].MAX_LENGTH),
      index: 0,
    ...
    {
      check: () => !isExactDigitLength(date.year, CARD_INFO_VALID_RULE[CardInfoType.EXPDATE].MAX_LENGTH),
      index: 1,
...
const cardPasswordValidator = (input) => {
  const validations = [
    { check: () => !isNumeric(input), index: 0, message: ERROR_MESSAGES.CARD_PASSWORD.NOT_NUMERIC },
    {
      check: () => !isExactDigitLength(input, CARD_INFO_VALID_RULE[CardInfoType.PASSWORD].MAX_LENGTH),
      index: 0,
...
const isExactDigitLength = (input, length) => {
  return input.length === length;
};
const isValidExpirationMonth = (month) => {
...
const isValidMonth = (month, year) => {
  const currentDate = /* @__PURE__ */ new Date();
  const currentYear = currentDate.getFullYear().toString().slice(-2);
  const currentMonth = (currentDate.getMonth() + 1).toString().padStart(2, "0");
  return year > currentYear || year === currentYear && month >= currentMonth;
};
var CARD_COMPANIES = /* @__PURE__ */ ((CARD_COMPANIES2) => {
  CARD_COMPANIES2["BC"] = "BC카드";
  CARD_COMPANIES2["SHINHAN"] = "신한카드";
  CARD_COMPANIES2["KAKAO"] = "카카오뱅크";
  CARD_COMPANIES2["HYUNDAI"] = "현대카드";
  CARD_COMPANIES2["WOORI"] = "우리카드";
  CARD_COMPANIES2["LOTTE"] = "롯데카드";
  CARD_COMPANIES2["HANA"] = "하나카드";
  CARD_COMPANIES2["KB"] = "국민카드";
  return CARD_COMPANIES2;
})(CARD_COMPANIES || {});
const CARD_COMPANIES_ARRAY = [
  "BC카드",
  "신한카드",
  "카카오뱅크",
  "현대카드",
...
const CARD_COMPANIES_COLOR = Object.freeze({
  [
    "BC카드"
    /* BC */
  ]: "#F04651",
...
const CARD_COMPANIES_DEFAULT_COLOR = "#333333";
...
function useCardInfo() {
  ...
  const [currentSection, setCurrentSection] = reactExports.useState(CardInfoType.NUMBER);
  const [completedSections, setCompletedSections] = reactExports.useState({
  ...
  const handleExpDateChange = (key, value) => {
    setCardInfo((prev) => {
  ...
  const validateExpDate = (expirationDate) => {
  ...
  const checkCardNumberComplete = (cardNumber) => {
    if (cardNumber.every((num) => num.length === CARD_INFO_VALID_RULE[CardInfoType.NUMBER].MAX_LENGTH))
      completeSection(CardInfoType.NUMBER);
  };
  const checkExpDateComplete = (expirationDate) => {
    if (expirationDate.month.length === CARD_INFO_VALID_RULE[CardInfoType.EXPDATE].MAX_LENGTH && expirationDate.year.length === CARD_INFO_VALID_RULE[CardInfoType.EXPDATE].MAX_LENGTH)
      completeSection(CardInfoType.EXPDATE);
  };
  const checkCVCComplete = (cvc) => {
    if (cvc.length === CARD_INFO_VALID_RULE[CardInfoType.CVC].MAX_LENGTH)
      completeSection(CardInfoType.CVC);
  };
  const checkPasswordComplete = (password) => {
    if (password.length === CARD_INFO_VALID_RULE[CardInfoType.PASSWORD].MAX_LENGTH)
      completeSection(CardInfoType.PASSWORD);
  };
  const setSectionState = (sectionType, state) => {
    setCompletedSections((prev) => ({
      ...prev,
      [sectionType]: state
    }));
  };
  const completeSection = (sectionType) => {
    ...
    if (!completedSections[nextSection] && SECTION_ORDER.indexOf(currentSection) <= currentSectionIndex) {
...
const PREVIEW_CLASS_NAMES = {
  ...
  INFO_CONTAINER: "card-preview-info-container",
  INFO_CARD_NUMBER_CONTAINER: "card-preview-info-card-number-container",
  INFO_TEXT: "card-preview-info-text",
  SECRET: "secret"
};
const getCardCompanyKey = (companyName) => {
  const companyKey = Object.keys(CARD_COMPANIES).find(
    (key) => CARD_COMPANIES[key] === companyName
  );
  return companyKey;
};
const getCardCompanyColor = (companyName) => {
  if (!companyName) return CARD_COMPANIES_DEFAULT_COLOR;
  const companyKey = getCardCompanyKey(companyName);
  return companyKey ? CARD_COMPANIES_COLOR[CARD_COMPANIES[companyKey]] : CARD_COMPANIES_DEFAULT_COLOR;
};
function Preview({ cardInfo }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: WRAPPER, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: CONTAINER, style: { backgroundColor: cardBackgroundColor }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: PREVIEW_CONTAINER, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${CARD_PREVIEW} ${PAYMENT_SIM}` }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${CARD_PREVIEW} ${PAYMENT_METHOD}`, children: imgSrc !== "" && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: imgSrc, alt: "cardType", className: CARD_PREVIEW }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: INFO_CONTAINER, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: INFO_CARD_NUMBER_CONTAINER, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: INFO_TEXT, children: cardInfo == null ? void 0 : cardInfo.cardNumber[0] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: INFO_TEXT, children: cardInfo == null ? void 0 : cardInfo.cardNumber[1] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${INFO_TEXT} ${SECRET}`, children: "•".repeat((_a = cardInfo.cardNumber[2]) == null ? void 0 : _a.length) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${INFO_TEXT} ${SECRET}`, children: "•".repeat((_b = cardInfo.cardNumber[3]) == null ? void 0 : _b.length) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: INFO_TEXT, children: [
...
function CardInfoSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "card-info-section", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "card-info-title", children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "card-info-description", children: description })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-info-sub-section", children: [
      inputType !== InputType.SELECT && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "card-info-subtitle", children: subTitle }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-info-input-container", children: inputArr.map((input, index) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "card-info-error", children: error && errorKey in error ? error[errorKey][1] : "" })
    ] })
  ] });
}
function CardInfoContainer({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-info-container", children: activeSectionConfigs.reverse().map((config) => /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoSection, { ...config, onChange, error }, config.id)) });
}
const CardRegistration = () => {
  const { cardInfo, handleCardInfoChange, error, currentSection, isAllSectionsCompleted } = useCardInfo();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "card-content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Preview, { cardInfo }),
    ...
    isAllSectionsCompleted && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", className: "submit-button", children: "확인" })
  ] }) });
};
const CardComplete = () => {
  var _a, _b;
  ...
  const cardNumber = ((_a = location.state) == null ? void 0 : _a.cardNumber) || "0000";
  const cardCompany = ((_b = location.state) == null ? void 0 : _b.cardCompany) || "BC카드";
  const handleConfirm = () => {
    navigate(ROUTES.CARD_REGISTRATION);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-complete-container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-complete-content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "icon-check", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: ICON_PATH.CHECK, alt: "icon_check" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "complete-message-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: `${cardNumber}로 시작하는` }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: `${cardCompany}가 등록되었어요.` })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "confirm-button", onClick: handleConfirm, children: "확인" })
  ] }) });
};
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: ROUTES.CARD_REGISTRATION, element: /* @__PURE__ */ jsxRuntimeExports.jsx(CardRegistration, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: ROUTES.CARD_COMPLETE, element: /* @__PURE__ */ jsxRuntimeExports.jsx(CardComplete, {}) })
  ] }) });
}
